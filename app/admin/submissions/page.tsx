    ...
    <ProtectedRoute requireAdmin={true}>
      <div className="max-w-7xl mx-auto px-6 py-10 min-h-screen">
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-widest mb-6 border border-indigo-100"
          >
                 ...
                 <table className="w-full text-left border-collapse">
                     <thead>
                         <tr className="bg-gray-50 text-xs font-bold text-gray-500 uppercase tracking-widest border-b border-gray-200">
                             ...
                             <th className="px-6 py-4">Team Reference</th>
                                ...
                                <tr key={sub.id} className="group hover:bg-gray-50/50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="font-bold text-gray-900 text-sm tracking-tight mb-0.5">Proposal.pdf</p>
                                                <p className="text-[10px] font-mono font-medium text-gray-500 uppercase">{sub.id.substring(0,8)}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2 text-gray-600">
                                            ...
                                            <p className="text-sm font-medium">{sub.teamId}</p>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2 text-gray-600">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <a 
                                                ...
                                                target="_blank" 
                                                rel="noreferrer"
                                                className="h-9 px-4 rounded-lg bg-indigo-50 border border-indigo-100 text-indigo-700 flex items-center justify-center gap-2 hover:bg-indigo-600 hover:text-white transition-colors text-xs font-bold shadow-sm"
                                            >
                                                <ExternalLink className="w-3.5 h-3.5" />
                                                View PDF
                                            </a>
                                            <button className="h-9 w-9 flex items-center justify-center rounded-lg border border-transparent text-gray-400 hover:text-gray-900 hover:bg-gray-100 transition-colors">
